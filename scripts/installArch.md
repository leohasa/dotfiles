...
```bash
pacman -S grub efibootmgr os-prober ntfs-3g networkmanager openssh base-devel linux-lts-headers mtools dosfstools bluez bluez-utils cups
```
...
### Audio (opción recomendada: PipeWire)
```bash
